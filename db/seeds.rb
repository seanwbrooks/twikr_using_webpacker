...
Review.create(tweet_id: 3, user_id: 2, comment: "I don't know if I like this stock.")
Review.create(tweet_id: 2, user_id: 1, comment: "I think it's going up.")
Review.create(tweet_id: 2, user_id: 2, comment: "I have this going to 200.00 by Q3.")
